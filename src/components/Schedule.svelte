...
<div class="w-96 flex-col gray-text bg-gray-200 hidden lg:flex  ">
    ...
    <div class="h-16 hidden mx-2 lg:flex justify-center  text-center items-center">
        <div class="w-2/12">
        <a role="button"  on:click={()=> {increaseDay(true)}} class="rounded-full border-transparent hover:bg-green-300 dgray-text px-0 mx-0 ">
        ...
        <div class="w-2/12">
        <a role="button" on:click={()=> {increaseDay(false)}}  class="float-right rounded-full border-transparent hover:bg-green-300 dgray-text C:\Programming\EpiCal\src\components\Schedule.svelte  ">
